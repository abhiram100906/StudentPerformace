...
def main(userid, host):
    ...
    row.append(str(userid))
    row.append(str(blinkCount))
    row.append(str(yawnCount))
    row.append(str(lostFocusCount))
    row.append(str(lostFocusDuration))
    row.append(str(faceNotPresentDuration))
                
    with open('../data/metrics.csv','a+') as csvFile:
    ...
    emailSvc.sendMail( ["amdamdmandyam@gmail.com"],
                                       "Student Performace Report",
                                        "Hi Parent, PFA your wards performance report",
                                        ['../data/metrics.csv'] )
